...
public class TextUtils {
	...
	public static String noNumbers(String strCnpj){
		if(isEmpty(strCnpj))
			return "";

		strCnpj = strCnpj.replaceAll("[^a-zA-Z]","");

    return strCnpj;
  }

	public static String noSpecialChars(String strCnpj){
		if(isEmpty(strCnpj))
			return "";

		strCnpj = strCnpj.replaceAll("[^a-zA-Z0-9]","");
...
//		s = s.replaceAll("[^a-zA-Z0-9\\-\\/]","");
	...
	public static boolean contains(String string1,String string2){
		...
		String novaString1 = string1.toLowerCase(Locale.getDefault()).trim();
		String novaString2 = string2.toLowerCase(Locale.getDefault()).trim();
