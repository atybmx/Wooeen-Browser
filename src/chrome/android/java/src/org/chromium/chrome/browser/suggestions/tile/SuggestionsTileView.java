...
public class SuggestionsTileView extends TileView {
    ...
    protected void setIconViewLayoutParams(Tile tile) {
        ...
        if (tile.getType() == TileVisualType.ICON_COLOR
            ...
            params.width = resources.getDimensionPixelSize(R.dimen.brave_tile_view_icon_size_modern);
            params.height=resources.getDimensionPixelSize(R.dimen.brave_tile_view_icon_size_modern);
            params.topMargin=resources.getDimensionPixelSize(R.dimen.brave_tile_view_icon_margin_top_modern);
        } else {
