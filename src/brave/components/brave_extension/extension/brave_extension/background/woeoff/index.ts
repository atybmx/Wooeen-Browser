...
import MessageTypes = Background.MessageTypes.Offer

const ALARM_KEY_FEED_UPDATE = 'woe-off-update-feed'
...
.catch((err) => {
  console.error('Could not startup Wooeen Offer Feed', err)
})

Background.setListener<Wooeen.FeedOffer | undefined>(
  MessageTypes.getOffers,
