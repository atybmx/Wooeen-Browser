...
import MessageTypes = Background.MessageTypes.Task

const ALARM_KEY_FEED_UPDATE = 'woe-tsk-update-feed'
...
.catch((err) => {
  console.error('Could not startup Wooeen Task Feed', err)
})

Background.setListener<Wooeen.FeedTask | undefined>(
  MessageTypes.getTasks,
