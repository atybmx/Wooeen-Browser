...
import MessageTypes = Background.MessageTypes.Post

const ALARM_KEY_FEED_UPDATE = 'woe-pos-update-feed'
...
.catch((err) => {
  console.error('Could not startup Wooeen Post Feed', err)
})

Background.setListener<Wooeen.FeedPost | undefined>(
  MessageTypes.getPosts,
