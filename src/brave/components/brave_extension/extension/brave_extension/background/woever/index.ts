...
import MessageTypes = Background.MessageTypes.Version

const ALARM_KEY_FEED_UPDATE = 'woe-ver-update-feed'
const ALARM_KEY_FEED_MEMORY = 'woe-ver-memory-feed'
...
.catch((err) => {
  console.error('Could not startup Wooeen Version Feed', err)
})

Background.setListener<Wooeen.Version | undefined>(
  MessageTypes.getScript,
