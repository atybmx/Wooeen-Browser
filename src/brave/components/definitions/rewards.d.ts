...
declare namespace Wooeen {
  ...
  export type Wallet = {
    conversionsPending: number;
  	conversionsRegistered: number;
  	conversionsApproved: number;
  	conversionsRejected: number;
  	conversionsWithdrawn: number;
  	amountPending: number;
  	amountRegistered: number;
  	amountApproved: number;
  	amountRejected: number;
  	amountWithdrawn: number;
  	recommendationsRegistered: number;
  	recommendationsConverted: number;
  	recommendationsConfirmed: number;
    recommendationsRegisteredAmount: number;
