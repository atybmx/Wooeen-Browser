  ...
  switch (action.type) {
    case types.NEW_TAB_SET_INITIAL_DATA:
      ...
      state = {
        ...
        woeUser: initialDataPayload.woeUser,
        woePosts: initialDataPayload.woePosts,
        woeTasks: initialDataPayload.woeTasks,
        woeOffers: initialDataPayload.woeOffers,
        woeCoupons: initialDataPayload.woeCoupons,
        woeCountry: initialDataPayload.woeCountry
      }
