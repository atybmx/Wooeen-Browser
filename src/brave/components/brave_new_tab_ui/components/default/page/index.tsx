...
export const GridItemRealbox = styled('section')`
...
`
export const GridItemCtas = styled('section')`
  grid-column: 2;
  ${singleColumnSmallViewport}
`
...
export const GridItemNavigationWooeenNews = styled('div')<{}>`
  position: absolute;
  bottom: 20px;
  left: 50%;
...
export const LeftPanelC1 = styled('div')`
  width: 220px;
  display: flex;
  flex-direction: column;
  align-items: center;
...
export const LeftPanelC2 = styled('div')`
  border-radius: 25px;
