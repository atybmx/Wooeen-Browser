...
export const NavMenuItem = styled('li')<NavMenuItemProps>`
  ...
  @media (prefers-color-scheme: dark) {
    filter: drop-shadow(0px 5px 5px #333c41);
  }
...
export const NavMenuItemName = styled('span')`
  display:none;
  margin-right: 5px;
  font-size: 12px;
  color: #3e40e6;
...
export const CtaLinkPanel = styled('div')<{}>`
  display: block;
  text-align:center;
  width:100%;
  padding: 30px 0;
...
export const CtaLink = styled('a')<{}>`
  ...
  font-weight: 700;
  font-size: 16px;
  background-image: linear-gradient(to right, #a2304f, #cd302c, #e2562a, #e7712c, #eb8831);
  border: none;
  outline: none;
  padding: 25px 40px;
  border-radius: 50px;
  ...
  transition: 0.4s;
  &:hover {
    background-image: linear-gradient(to left, #01b19e, #297194);
  }
`
