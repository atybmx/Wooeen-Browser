...
export function saveShowNews (value: boolean): void {
  sendSavePref('showNews', value)
}

export function saveShowCtas (value: boolean): void {
  sendSavePref('showCtas', value)
}

export function saveShowRealbox (value: boolean): void {
  sendSavePref('showRealbox', value)
}

export function saveShowBalance (value: boolean): void {
  sendSavePref('showBalance', value)
}

export function saveShowCashback (value: boolean): void {
  sendSavePref('showCashback', value)
}

export function saveShowRecommendation (value: boolean): void {
  sendSavePref('showRecommendation', value)
}
