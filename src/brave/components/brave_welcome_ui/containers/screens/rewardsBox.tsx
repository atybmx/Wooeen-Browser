...
export default class PaymentsBox extends React.PureComponent<Props, {}> {
  ...
  renderTerms () {
    const [
      ...
      link2,
      afterLink2
    ] = splitMessage('woeCashbackTerms')

    return (
      <>
        {beforeLink1}
        <a
          href='https://www.wooeen.com/terms'
          target='_blank'
        ...
        {afterLink1}
        <a
          href='https://www.wooeen.com/privacy-policy'
          target='_blank'
          rel='noopener noreferrer'
        >
          {link2}
  ...
  render () {
    ...
    return (
      ...
      >
        <WelcomeRewardsImage />
        <Title>{getLocale('woeCashbackTitle')}</Title>
