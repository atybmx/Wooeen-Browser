...
export class WelcomePage extends React.Component<Props, State> {
  ...
  onClickRewardsGetStarted = () => {
    this.props.actions.goToTabRequested('https://app.wooeen.com/u/login', '_blank')
  }
        ...
        >
          <Panel>
            <SlideContent>
              ...
              />
              <RewardsBox index={3} currentScreen={this.currentScreen} onClick={this.onClickRewardsGetStarted} />
            </SlideContent>
            <FooterBox
