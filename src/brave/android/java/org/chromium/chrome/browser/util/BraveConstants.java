...
public final class BraveConstants {
    ...
    public static final String BRAVE_PRODUCTION_PACKAGE_NAME = "com.wooeen.browser";
    public static final String BRAVE_BETA_PACKAGE_NAME = "com.wooeen.browser_beta";
    public static final String BRAVE_NIGHTLY_PACKAGE_NAME = "com.wooeen.browser_nightly";

    // used in BraveNtpAdapter
    public static final String BRAVE_REF_URL = "https://app.wooeen.com/u/task/recommendations";
    public static final String BRAVE_NEWS_LEARN_MORE_URL =
            "https://www.wooeen.com/privacy-policy";
