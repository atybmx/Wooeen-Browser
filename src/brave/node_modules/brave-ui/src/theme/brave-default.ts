...
const theme: ITheme = {
  ...
  color: {
    ...
    primaryBackgroundImage: 'linear-gradient(to right, #a2304f, #cd302c, #e2562a, #e7712c, #eb8831)',
    contextMenuBackground: colors.white,
    contextMenuHoverBackground: colors.blurple200,
    secondaryBackground: colors.grey400,
    secondaryBackgroundImage: 'linear-gradient(to left, #01b19e, #297194)',
