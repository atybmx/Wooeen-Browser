...
//WOE new tab widgets
extern const char kNewTabPageShowCtas[];
extern const char kNewTabPageShowRealbox[];
extern const char kNewTabPageShowNews[];
extern const char kNewTabPageShowBalance[];
extern const char kNewTabPageShowCashback[];
extern const char kNewTabPageShowRecommendation[];
