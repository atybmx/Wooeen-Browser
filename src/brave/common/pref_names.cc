...
//WOE new tab widgets
const char kNewTabPageShowCtas[] = "brave.new_tab_page.show_ctas";
const char kNewTabPageShowRealbox[] = "brave.new_tab_page.show_realbox";
const char kNewTabPageShowNews[] = "brave.new_tab_page.show_news";
const char kNewTabPageShowBalance[] = "brave.new_tab_page.show_balance";
const char kNewTabPageShowCashback[] = "brave.new_tab_page.show_cashback";
const char kNewTabPageShowRecommendation[] = "brave.new_tab_page.show_recommendation";
