...
extension Strings {
  public struct Widgets {
    public static let noFavoritesFound = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Please open Wooeen to view your favorites here",
    ...
    public static let shortcutsWidgetDescription = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Quick access to search the web or open web pages in Wooeen.",
    ...
    public static let shieldStatsTitle = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Privacy Stats",
      comment: "Title for Wooeen Shields widget on 'add widget' screen."
    )

    public static let shieldStatsDescription = NSLocalizedString(
      "widgets.shieldStatsDescription",
      bundle: widgetBundle,
      value: "A summary of how Wooeen saves you time and protects you online.",
      comment: "Description for Wooeen Shields widget on 'add widget' screen."
    )
    ...
    public static let shieldStatsWidgetTitle = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Privacy Stats",
      comment: "Title of Wooeen Shields widget shown above stat numbers."
    )
    ...
    public static let singleStatTitle = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Privacy Stat",
      comment: "Title for Wooeen Shields single stat widget on 'add widget' screen."
    )

    public static let singleStatDescription = NSLocalizedString(
      "widgets.singleStatDescription",
      bundle: widgetBundle,
      value: "A summary of how Wooeen has protected you online.",
      comment: "Description for Wooeen Shields single stat widget on 'add widget' screen."
    )
    ...
    public static let walletShortcutTitle = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Wooeen Wallet",
      comment: "Description for the Wooeen Wallet option on the 'shortcuts' widget."
    )
    ...
    public static let newsClusteringWidgetTitle = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Top News",
      comment: "Title for Wooeen News widgets that display the top news"
    )
    public static let newsClusteringWidgetDescription = NSLocalizedString(
      ...
      comment: "Description for Wooeen News widgets that display the top news"
    )
    ...
    public static let newsClusteringReadMoreButtonTitle = NSLocalizedString(
      ...
      bundle: widgetBundle,
      value: "Read More",
      comment: "Displayed on a news widget that links into the app to read more Wooeen News content"
    )
