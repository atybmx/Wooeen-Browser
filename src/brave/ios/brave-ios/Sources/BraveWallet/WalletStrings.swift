...
extension Strings {
  public struct Wallet {
    public static let braveWallet = NSLocalizedString(
      ...
      value: "Brave Wallet",
      comment:
        "The title shown on the wallet settings page, and the value shown when selecting the default wallet as Wooeen Wallet in wallet settings."
    )
    public static let wallet = NSLocalizedString(
      ...
      bundle: .module,
      value: "Wallet",
      comment: "The title shown on the menu to access Wooeen Wallet"
    )
    ...
    public static let restoreWalletButtonTitle = NSLocalizedString(
      ...
      value: "Restore",
      comment:
        "The button title for showing the restore wallet screen. As in to use your recovery phrase to bring a wallet into Wooeen"
    )
    ...
    public static let setupCryptoSubtitle = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Take control of your crypto and NFTs. Wooeen Wallet supports Ethereum, EVM chains, Solana and more.",
    ...
    public static let setupCryptoCreateNewSubTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Get started with Wooeen Wallet within minutes.",
      comment:
    ...
    public static let setupCryptoDisclaimer = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "©2023 Wooeen Software Inc. Wooeen and the Wooeen logo are registered trademarks of Wooeen. Other product names and logos may be trademarks of their respective companies. All rights reserved.",
    ...
    public static let legalUserResponsibility = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "I understand this is a self-custody wallet, and that I alone am responsible for any associated funds, assets, or accounts, and for taking appropriate action to secure, protect and backup my wallet. I understand that Wooeen cannot access my wallet or reverse transactions on my behalf, and that my recovery phrase is the ONLY way to regain access in the event of a lost password, stolen device, or similar circumstance.",
      comment:
    ...
    public static let onboardingCompletedSubTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Your Wooeen Wallet is ready to use.",
    ...
    public static let restoreLegacyBraveWalletToggleLabel = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Import from legacy Wooeen crypto wallets?",
    ...
    public static let settingsResetWalletAlertTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Are you sure you want to reset Wooeen Wallet?",
      comment:
    ...
    public static let biometricsSetupTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Unlock Wooeen Wallet with %@",
      comment:
    ...
    public static let biometricsSetupSubTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Would you like to use %@ to unlock Wooeen Wallet?",
      comment:
    ...
    public static let autoLockFooter = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "The number of minutes to wait until the Wooeen Wallet is automatically locked",
    ...
    public static let swapCryptoUnsupportNetworkDescription = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Wooeen doesn't currently support swap on the %@. Please switch to a supported chain.",
      comment:
    ...
    public static let braveFeeLabel = NSLocalizedString(
      ...
      value: "Brave Fee: %@",
      comment:
        "The title for Wooeen Fee label in Swap. The fee percentage is displayed beside the label."
    )
    ...
    public static let braveSwapFree = NSLocalizedString(
      ...
      value: "Free",
      comment:
        "The text beside the striked-through percentage Wooeen would normally charge for a swap."
    )
    ...
    public static let swapDexAggrigatorNote = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Wooeen uses %@ as a DEX aggregator.",
      comment:
    ...
    public static let swapDexAggrigatorDisclaimer = NSLocalizedString(
      ...
      comment:
        "A longer disclaimer about the DEX aggrigator used by Wooeen for swap transactions. The first '%@' is a company name. 'DEX aggregator' is a type of blockchain-based service (decentralized exchange). 'ONLY' is emphasized to show importance of the company's data usage."
    )
    ...
    public static let braveSwapFeeDisclaimer = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Quote includes a %@ Wooeen fee.",
      comment:
        "A disclaimer that appears at the bottom of an swap screen which discloses the fixed Wooeen fee included in the swap quotes. '%@' will be replaced by a percentage. For example: 'Quote includes a 0.875% Wooeen fee'"
    )
    ...
    public static let recoveryPhraseScreenshotDetectedMessage = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Warning: A screenshot of your recovery phrase may get backed up to a cloud file service, and be readable by any application with photos access. Wooeen recommends that you not save this screenshot, and delete it as soon as possible.",
    ...
    public static let privateKeyScreenshotDetectedMessage = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Warning: A screenshot of your private key may get backed up to a cloud file service, and be readable by any application with photos access. Wooeen recommends that you not save this screenshot, and delete it as soon as possible.",
    ...
    public static let dappsConnectionNotificationTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "This page wants to interact with Wooeen Wallet",
      comment:
        "The title of the notification which will prompt at the top of the browser when users are visiting web3 site that is not yet connected with Wooeen Wallet."
    )
    public static let dappsConnectionNotificationOriginTitle = NSLocalizedString(
      "wallet.dappsConnectionNotificationOriginTitle",
      tableName: "BraveWallet",
      bundle: .module,
      value: "%@ wants to interact with Wooeen Wallet",
      comment:
        "The title of the notification which will prompt at the top of the browser when users are visiting web3 site that is not yet connected with Wooeen Wallet. The '%@' will be the site attempting to connect. For example: \"app.uniswap.org wants to interact with Wooeen Wallet\""
    )
    ...
    public static let newSiteConnectMessage = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Connect to Wooeen Wallet",
    ...
    public static let addNetworkDescription = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "This will allow this network to be used within Wooeen Wallet.",
      comment:
    ...
    public static let editSiteConnectionScreenTitle = NSLocalizedString(
      ...
      value: "Connections",
      comment:
        "The navigation title of the screen for users to edit dapps site connection with users' Wooeen Wallet accounts."
    )
    ...
    public static let decryptMessageScreenshotDetectedMessage = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Warning: A screenshot of your message may get backed up to a cloud file service, and be readable by any application with photos access. Wooeen recommends that you not save this screenshot, and delete it as soon as possible.",
      comment:
    ...
    public static let networkNotSupportedForBuyToken = NSLocalizedString(
      ...
      comment:
        "A placeholder in Buy Screen, when user switched to a network that Wooeen currently doesn't support token purchasing."
    )
    ...
    public static let dappsSettingsConnectedSitesSectionEmpty = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "DApps you connect to Wooeen Wallet will appear here",
      comment:
    ...
    public static let web3DomainOptionAsk = NSLocalizedString(
      ...
      value: "Ask",
      comment:
        "One of the options for Wooeen to handle Ethereum/Solana Name Service domain name and IPFS scheme url. 'Ask' means Wooeen will ask user first before enable or disable resolving ENS/SNS domain name and IPFS scheme url."
    )
    public static let web3DomainOptionEnabled = NSLocalizedString(
      ...
      value: "Enabled",
      comment:
        "One of the options for Wooeen to handle Ethereum/Solana Name Service domain name and IPFS scheme url. 'Enabled' means Wooeen will enable resolving ENS/SNS domain name and IPFS scheme url."
    )
    public static let web3DomainOptionDisabled = NSLocalizedString(
      ...
      value: "Disabled",
      comment:
        "One of the options for Wooeen to handle Ethereum/Solana Name Service domain name and IPFS scheme url. 'Disabled' means Wooeen will disable resolving ENS/SNS domain name and IPFS scheme url."
    )
    ...
    public static let ensOffchainGatewayTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Wooeen supports using offchain gateways to resolve .eth domains.",
      comment:
    ...
    public static let web3IPFSInterstitialProceedButton = NSLocalizedString(
      ...
      comment:
        "The title of the button that user will click to let Wooeen to resolve IPFS shceme url."
    )
    ...
    public static let web3IPFSInterstitialIPFSPrivacy = NSLocalizedString(
      ...
      comment:
        "A brief explaination of IPFS on privacy. The first '%@' will be replaced with a link to a Wooeen article that explains how does IPFS impact users' privacy in details. The second '%@' will be replaced with 'web3IPFSInterstitialIPFSPrivacyLearnMore'."
    )
    ...
    public static let web3DomainInterstitialPageTAndU = NSLocalizedString(
      ...
      value: "terms of use",
      comment:
        "Hyper link copy displayed as part of 'snsDomainInterstitialPageDescription'. It will redirect user to the 'terms of use' webpage of the server that Wooeen uses to resolve SNS domain."
    )
    public static let web3DomainInterstitialPagePrivacyPolicy = NSLocalizedString(
      ...
      comment:
        "Hyper link copy displayed as part of 'snsDomainInterstitialPageDescription'. It will redirect user to the privay policy webpage of the server that Wooeen uses to resolve SNS domain."
    )
    public static let web3DomainInterstitialPageButtonDisable = NSLocalizedString(
      ...
      value: "Disable",
      comment:
        "Title on the button that users can click to disable Wooeen to resolve the ENS/SNS domain they entered."
    )
    // SNS
    public static let snsDomainInterstitialPageTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Enable Support of Solana Name Service (SNS) in Wooeen?",
      comment:
        "Title displayed when users chose Wooeen to ask them if they want the SNS to be resolved every time they enter one."
    )
    public static let snsDomainInterstitialPageDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Wooeen will use a third-party to resolve .sol domain names. Wooeen hides your IP address. If you enable this, the third-party will see that someone is trying to visit these .sol domains, but nothing else. For more information about which third-parties we use and their privacy policies, please see our <a href=%@>help page</a>.",
      comment:
        "Description displayed when users chose Wooeen to ask them if they want the SNS to be resolved every time they enter one. The first '%@' will be replaced with a link to Wooeen's wiki page which will link to the providersterms of use page and privacy policy page. The last '%@' will be replaced with the value of 'snsDomainInterstitialPagePrivacyPolicy'."
    )
    public static let snsDomainInterstitialPageButtonProceed = NSLocalizedString(
      ...
      comment:
        "Title on the button that users can click to enable Wooeen to resolve the SNS domain they entered."
    )
    // ENS
    public static let ensDomainInterstitialPageTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Enable Support of Ethereum Name Service (ENS) in Wooeen?",
      comment:
        "Title displayed when users chose Wooeen to ask them if they want the ENS domain to be resolved every time they enter one."
    )
    public static let ensDomainInterstitialPageDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Wooeen will be using Infura to resolve .eth domain names that are on Ethereum Name Service (ENS). Wooeen hides your IP address. If you enable this, Infura will see that someone is trying to visit these .eth domains but nothing else. See Infura's <a href=%@>%@</a> and <a href=%@>%@</a>.",
      comment:
        "Description displayed when users chose Wooeen to ask them if they want the ENS to be resolved every time they enter one. The first '%@' will be replaced with a link to Infura's terms of use page. The second '%@' will be replaced with the value of 'Web3DomainInterstitialPageTAndU'. The third '%@' will be replaced with a link to Infura's privacy policy page. The last '%@' will be replaced with the value of 'Web3DomainInterstitialPagePrivacyPolicy'."
    )
    public static let ensDomainInterstitialPageButtonProceed = NSLocalizedString(
      ...
      comment:
        "Title on the button that users can click to enable Wooeen to resolve the ENS domain they entered."
    )
    // ENS offchain
    public static let ensOffchainDomainInterstitialPageTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Enable support of Ethereum Name Service (ENS) offchain lookup in Wooeen?",
      comment:
        "Title displayed when users chose Wooeen to ask them if they want the ENS Offchain domain to be resolved every time they enter one."
    )
    public static let ensOffchainDomainInterstitialPageDescription = NSLocalizedString(
      ...
      comment:
        "Description displayed when users chose Wooeen to ask them if they want the ENS to be resolved every time they enter one. The first '%@' will be replaced with a link to Wooeen Wallet's offchain lookup privacy considerations. The second '%@' will be replaced with the value of 'ensOffchainDomainInterstitialLearnMore'."
    )
    public static let ensOffchainDomainInterstitialPageButtonProceed = NSLocalizedString(
      ...
      comment:
        "Title on the button that users can click to enable Wooeen to resolve the ENS offchain lookup for the domain they entered."
    )
    // Unstoppable Domains
    public static let udDomainInterstitialPageTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Enable support of Unstoppable Domains in Wooeen?",
      comment:
        "Title displayed when users chose Wooeen to ask them if they want the Unstoppable Domains domain to be resolved every time they enter one."
    )
    ...
    public static let nftDiscoveryCalloutDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Wooeen Wallet can use a third-party service to automatically display your NFTs. Wooeen will share your wallet addresses with SimpleHash to provide this service. Learn more.",
      comment:
    ...
    public static let nftRemoveFromWalletAlertTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Remove from Wooeen Wallet?",
    ...
    public static let nftRemoveFromWalletAlertDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "NFT will be removed from Wooeen Wallet but will remain on the blockchain. If you remove it, then change your mind, you'll need to import it again manually.",
    ...
    public static let signInWithBraveWallet = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Sign in with Wooeen Wallet",
    ...
    public static let signInWithBraveWalletMessage = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "You are signing into %@. Wooeen Wallet will share your wallet address with %@.",
      comment:
        "The title of the view shown when a security issue is detected with a Sign In With Ethereum request."
    )
    ...
    public static let siweSignInButtonTitle = NSLocalizedString(
      ...
      value: "Sign In",
      comment:
        "The label displayed on the button to sign in for Sign In With Ethereum/Wooeen Wallet requests."
    )
    public static let siweOriginLabel = NSLocalizedString(
      ...
      value: "Origin",
      comment:
        "The label displayed in details for Sign In With Ethereum/Wooeen Wallet requests beside the origin."
    )
    public static let siweAddressLabel = NSLocalizedString(
      ...
      value: "Address",
      comment:
        "The label displayed in details for Sign In With Ethereum/Wooeen Wallet requests beside the address."
    )
    public static let siweURILabel = NSLocalizedString(
      ...
      value: "URI",
      comment:
        "The label displayed in details for Sign In With Ethereum/Wooeen Wallet requests beside the URI."
    )
    public static let siweVersionLabel = NSLocalizedString(
      ...
      value: "Version",
      comment:
        "The label displayed in details for Sign In With Ethereum/Wooeen Wallet requests beside the version."
    )
    public static let siweChainIDLabel = NSLocalizedString(
      ...
      value: "Chain ID",
      comment:
        "The label displayed in details for Sign In With Ethereum/Wooeen Wallet requests beside the chain ID."
    )
    public static let siweIssuedAtLabel = NSLocalizedString(
      ...
      value: "Issued At",
      comment:
        "The label displayed in details for Sign In With Ethereum/Wooeen Wallet requests beside the issued at date."
    )
    public static let siweExpirationTimeLabel = NSLocalizedString(
      ...
      comment:
        "The label displayed in details for Sign In With Ethereum/Wooeen Wallet requests beside the expiration time."
    )
    public static let siweNonceLabel = NSLocalizedString(
      ...
      value: "Nonce",
      comment:
        "The label displayed in details view for Sign In With Ethereum/Wooeen Wallet requests beside the nonce."
    )
    public static let siweStatementLabel = NSLocalizedString(
      ...
      value: "Statement",
      comment:
        "The label displayed in details view for Sign In With Ethereum/Wooeen Wallet requests beside the statement."
    )
    public static let siweDetailsTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "Details",
      comment: "The title of the details view for Sign In With Ethereum/Wooeen Wallet requests."
    )
    ...
    public static let btcOrdinalsUnsupportedWarning = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Wooeen Wallet does not currently support Bitcoin NFTs (ordinals). Sending BTC from an address that has ordinals may result in its ordinals being transferred inadvertently.",
