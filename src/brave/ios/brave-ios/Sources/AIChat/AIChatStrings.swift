...
extension Strings {
  public struct AIChat {
    ...
    public static let accountSessionExpiredDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Your Wooeen account session has expired. Please visit your account page to refresh, then come back to use premium features.",
      comment:
    ...
    public static let feedbackViewMainTitle = NSLocalizedString(
      ...
      tableName: "BraveLeo",
      bundle: .module,
      value: "Provide Wooeen AI Feedback",
      comment: "The title for view which user type feedback"
    )
    ...
    public static let chatIntroSubTitle = NSLocalizedString(
      ...
      tableName: "BraveLeo",
      bundle: .module,
      value: "An AI-powered intelligent assistant, built right into Wooeen.",
    ...
    public static let introMessageLlamaMessageDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Hi, I'm Leo. I'm a fully hosted AI assistant by Wooeen. I'm powered by Llama 3 8B, a model created by Meta to be performant and applicable to many use cases.",
    ...
    public static let introMessageMixtralMessageDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Hi, I'm Leo. I'm a fully hosted AI assistant by Wooeen. I'm powered by Mixtral 8x7B, a model created by Mistral AI to handle advanced tasks.",
      comment: "The model intro message when you first enter the chat assistant"
    )
    public static let introMessageClaudeHaikuMessageDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Hi, I'm Leo. I'm proxied by Wooeen and powered by Claude 3 Haiku, a model created by Anthropic to power conversational and text processing tasks.",
      comment: "The model intro message when you first enter the chat assistant"
    )
    public static let introMessageClaudeSonnetMessageDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Hi, I'm Leo. I'm proxied by Wooeen and powered by Claude 3 Sonnet, a model created by Anthropic to power conversational and text processing tasks.",
      comment: "The model intro message when you first enter the chat assistant"
    )
    public static let introMessageGenericMessageDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Hi, I'm Leo. I'm an AI assistant by Wooeen. I'm powered by %@. Ask me anything, and I'll do my best to answer.",
      comment:
    ...
    public static let advancedSettingsLinkPurchaseActionTitle = NSLocalizedString(
      ...
      comment: "The title for the button which links purchase to Wooeen Account"
    )
    public static let advancedSettingsLinkPurchaseActionSubTitle = NSLocalizedString(
      ...
      tableName: "BraveLeo",
      bundle: .module,
      value: "Link your App Store purchase to your Wooeen account to use Leo on other devices.",
      comment: "The subtitle for the button which links purchase to Wooeen Account"
    )
    ...
    public static let termsConditionsTitle = NSLocalizedString(
      ...
      tableName: "BraveLeo",
      bundle: .module,
      value: "Chat Privately with Wooeen Leo",
    ...
    public static let termsConditionsApprovalActionTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "I Understand",
      comment: "The title for expressing acknowledgement for the terms and conditions of Wooeen AI"
    )
    ...
    public static let speechRecognizerDisclaimer = NSLocalizedString(
      ...
      tableName: "BraveLeo",
      bundle: .module,
      value: "Wooeen does not store or share your voice inputs.",
      comment:
    ...
    public static let microphonePermissionAlertDescription = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Please allow microphone access in iOS system settings for Wooeen to use anonymous voice entry.",
      comment: "The description for alert needed to have microphone permission"
    )
    ...
    public static let leoPageContextInfoDescriptionTitle = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Toggle on to ask about this page. Its content will be sent to Wooeen Leo along with your messages.",
      comment:
        "The title to display when the user taps on the information icon on the page context view. Wooeen Leo is the name of the product and should not be translated."
    )
    ...
    public static let leoImprovingAnswerBraveSearch = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Improving answer with Wooeen Search...",
      comment:
