...
extension Strings {
  ...
  public static let sendCrashReportAlertMessage = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "Send a crash report so Wooeen can fix the problem?",
    comment:
  ...
  public static let restoreTabOnCrashAlertTitle = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "Wooeen Closed Unexpectedly.",
  ...
  public static let restoreTabOnCrashAlertMessage = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "Unfortunately, Wooeen crashed or did not close properly.\nRestore your tabs?",
...
extension Strings {
  ...
  public static let authenticationLoginsTouchReason = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "This authenticates your access to Wooeen",
    comment:
      "Touch ID or PIN entry prompt subtitle when accessing Wooeen with the Browser Lock feature enabled"
  )
}
...
extension Strings {
  ...
  public static let accessPhotoDeniedAlertTitle = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "Wooeen would like to access your Photos",
  ...
  public struct DefaultBrowserCallout {
    public static let introPrimaryText =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Open all links with Wooeen to protect your privacy",
    ...
    public static let introSecondaryText =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Wooeen Shields block trackers & ads, saves data, and saves you time on every site you visit",
    ...
    public static let introTertiaryText =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Open Settings, tap Default Browser App, and select Wooeen.",
    ...
    public static let notificationTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Get Wooeen protection, on every link",
        comment: "Notification title to promote setting Wooeen app as default browser"
      )
    ...
    public static let notificationBody =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Set Wooeen as your default browser",
        comment: "Notification body to promote setting Wooeen app as default browser"
      )
  }
}
  ...
  public struct Callout {
    ...
    public static let defaultBrowserCalloutDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "With Wooeen as default, every link you tap opens with Wooeen's privacy protections.",
    ...
    public static let defaultBrowserCalloutButtonDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Set Wooeen as Default Browser?",
        comment:
    ...
    public static let privacyEverywhereCalloutDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Get Wooeen privacy on your computer or tablet, and sync bookmarks & extensions between devices.",
    ...
    public static let p3aCalloutDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "This helps us learn what Wooeen features are used most often. Change at any time in Wooeen Settings under ‘Wooeen Shields and Other Privacy Settings.",
    ...
    public static let bottomBarCalloutTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Customize Wooeen Tabs Bar",
  ...
  public struct Onboarding {
    ...
    public static let blockedAdsOnboardingInstructionsText =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Tap to view Wooeen Shields",
    ...
    public static let blockedAdsOnboardingFootnoteText =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "See all the bad stuff Wooeen blocked, on every page, with Shields.",
        comment: "The footnote indicating what Wooeen shields is blocking"
      )
    ...
    public static let linkReceiptTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Extend your Wooeen Firewall + VPN protection",
    ...
    public static let linkReceiptDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Your Wooeen VPN subscription can protect up to 5 devices, across Android, iOS, and desktop. Just link your App Store subscription to your Wooeen account.",
...
extension Strings {
  public static let readerModeLoadingContentDisplayText = NSLocalizedString(
    ...
    comment:
      "Message displayed when the reader mode page is loading. This message will appear only when sharing to Wooeen reader mode from another app."
  )
  public static let readerModePageCantShowDisplayText = NSLocalizedString(
    ...
    comment:
      "Message displayed when the reader mode page could not be loaded. This message will appear only when sharing to Wooeen reader mode from another app."
  )
  public static let readerModeLoadOriginalLinkText = NSLocalizedString(
    ...
    comment:
      "Link for going to the non-reader page when the reader view could not be loaded. This message will appear only when sharing to Wooeen reader mode from another app."
  )
...
extension Strings {
  public struct CustomSearchEngine {
    ...
    public static let insecureSearchTemplateURLErrorDescription = NSLocalizedString(
      ...
      comment:
        "A description explaining that search template url is insecure, it is used for instance - Insecure Custom Search Template for Wooeen Search, Wooeen Search is a search engineand on a new seperate line"
    )
    ...
    public static let insecureSuggestionTemplateURLErrorDescription = NSLocalizedString(
      ...
      comment:
        "A description explaining that suggestion template url is insecure, it is used for instance - Insecure Custom Suggestion Template for Wooeen Search, Wooeen Search is name of search engine on a new seperate line"
    )
    ...
    public static let searchTemplateTitle = NSLocalizedString(
      ...
      comment:
        "Search Template title - for instance it will be used Search Template: Wooeen Search - Wooeen Search is the name of Search Engine on  seperate line"
    )
    ...
    public static let suggestionTemplateTitle = NSLocalizedString(
      ...
      comment:
        "Suggestion Template title - for instance it will be used Suggestion Template: Wooeen Search - Wooeen Search is the name of Search Engine on  seperate line"
    )
...
extension Strings {
  public struct OptionsMenu {
    ...
    public static let braveVPNItemTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "VPN",
      comment: "Wooeen VPN Item Menu title"
    )
    public static let braveVPNItemDescription = NSLocalizedString(
      ...
      comment: "The subtitle description of menu item Wooeen VPN"
    )
    public static let braveTalkItemTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "Talk",
      comment: "Wooeen Talk Item Menu title"
    )
    public static let braveTalkItemDescription = NSLocalizedString(
      ...
      comment: "The subtitle description of menu item Wooeen Talk"
    )
    public static let braveLeoItemDescription = NSLocalizedString(
      ...
      comment:
        "The subtitle description of menu item Wooeen Leo. Wooeen Leo is the name of a product and should not be translated."
    )
    public static let braveNewsItemTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "News",
      comment: "Wooeen News Item Menu title"
    )
    public static let braveNewsItemDescription = NSLocalizedString(
      ...
      comment: "The subtitle description of menu item Wooeen News"
    )
    ...
    public static let bravePlaylistItemDescription = NSLocalizedString(
      ...
      comment: "The subtitle description of menu item Wooeen Playlist"
    )
    public static let braveWalletItemDescription = NSLocalizedString(
      ...
      comment: "The subtitle description of menu item Wooeen Wallet"
    )
  }
}
...
extension Strings {
  public struct BraveSearchPromotion {
    public static let braveSearchPromotionBannerTitle = NSLocalizedString(
      ...
      comment: "Wooeen Search Banner Promotion title in Search Suggestions"
    )
    public static let braveSearchPromotionBannerDescription = NSLocalizedString(
      "braveSearchPromotion.bannerDescription",
      tableName: "BraveShared",
      bundle: .module,
      value: "Wooeen Search doesn't profile you.",
      comment: "Wooeen Search Banner Promotion description content in Search Suggestions"
    )
    public static let braveSearchPromotionBannerTryButtonTitle = NSLocalizedString(
      "braveSearchPromotion.bannerTryButtonTitle",
      tableName: "BraveShared",
      bundle: .module,
      value: "Try Wooeen Search",
      comment: "Wooeen Search Banner Promotion title for try button in Search Suggestions"
    )
    public static let braveSearchPromotionBannerMaybeLaterButtonTitle = NSLocalizedString(
      ...
      value: "Maybe later",
      comment:
        "Wooeen Search Banner Promotion title for maybe later button to activate promotion later in Search Suggestions"
    )
    public static let braveSearchPromotionBannerDismissButtonTitle = NSLocalizedString(
      ...
      value: "Dismiss",
      comment:
        "Wooeen Search Banner Promotion title for dismiss button to remove promotion in Search Suggestions"
    )
  }
}
...
extension Strings {
  ...
  public static let braveRewardsTitle = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "Wooeen Rewards",
    comment: "Wooeen Rewards title"
  )
  public static let braveRewardsSettingsTitle = NSLocalizedString(
    ...
    bundle: .module,
    value: "Rewards",
    comment: "Wooeen Rewards title in settings"
  )
  public static let hideRewardsIcon = NSLocalizedString(
    "HideRewardsIcon",
    tableName: "BraveShared",
    bundle: .module,
    value: "Hide Wooeen Rewards Icon",
  ...
  public static let hideRewardsIconSubtitle = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "Hides the Wooeen Rewards icon when Wooeen Rewards is not enabled",
  ...
  public static let openBraveRewardsSettings = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "Open Wooeen Rewards Settings",
    comment: "Button title for opening the Wooeen Rewards panel to settings"
  )
  public static let setDefaultBrowserSettingsCell =
    NSLocalizedString(
      ...
      comment: "Settings item to set the Wooeen as a default browser on the iOS device."
    )
  public static let setDefaultBrowserCalloutTitle =
    NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "Wooeen can now be set as your default browser in iOS. Tap here to open settings.",
      comment: ""
    )
  ...
  public struct Settings {
    ...
    public static let autocloseTabsSettingFooter =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Allow Wooeen to automatically close tabs that haven't recently been viewed.",
    ...
    public static let openYouTubeInBrave =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Open YouTube links in Wooeen",
        comment: "A toggle label which lets the user always open YouTube urls in Wooeen"
      )
    ...
    public static let sendUsagePingTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Automatically send daily usage ping to Wooeen",
    ...
    public static let sendUsagePingDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "This private ping lets Wooeen estimate active users.",
...
extension Strings {
  ...
  public static let errorPagesAdvancedErrorPinningDetails = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "%@ normally uses encryption to protect your information. When Wooeen tried to connect to %@ this time, the website sent back unusual and incorrect credentials. This may happen when an attacker is trying to pretend to be %@, or a Wi-Fi sign-in screen has interrupted the connection. Your information is still secure because Wooeen stopped the connection before any data was exchanged.<br />You cannot visit %@ right now because the website uses certificate pinning. Network errors and attacks are usually temporary, so this page will probably work later.",
    comment:
...
extension Strings {
  ...
  public static let braveSyncWelcome = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "To start, you will need Wooeen installed on all the devices you plan to sync. To chain them together, start a sync chain that you will use to securely link all of your devices together.",
  ...
  public static let syncToDeviceDescription = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "Using existing synced device open Wooeen Settings and navigate to Settings -> Sync. Choose \"Add Device\" and scan the code displayed on the screen.",
  ...
  public static let syncRemoveLastDeviceMessage = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "Data currently synced will be retained but all data in Wooeen’s Sync cache will be deleted. You will need to start a new sync chain to sync device data again.",
  ...
  public static let syncDeprecatedVersionError = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "It looks like this code was created on a device running an older version of Wooeen. Please update to the latest version of Wooeen on your other device, and then create a new sync code.",
    comment: "Sync Error Description"
  )
...
extension Strings {
  ...
  public static let persistentPrivateBrowsingAlertMessage = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "Allows Wooeen to restore private browsing tabs, even if you close / re-open the app",
  ...
  public static let shieldsDefaults = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "Wooeen Shields Global Defaults",
  ...
  public static let versionTemplate = NSLocalizedString(
    ...
    bundle: .module,
    value: "Version %@ (%@)",
    comment: "Version number of Wooeen shown in settings"
  )
  ...
  public static let rateBrave = NSLocalizedString(
    ...
    bundle: .module,
    value: "Rate Wooeen",
    comment: "Open the App Store to rate Wooeen."
  )
  ...
  public static let privacyPolicy = NSLocalizedString(
    ...
    comment: "Show Wooeen Browser Privacy Policy page from the Privacy section in the settings."
  )
  public static let termsOfUse = NSLocalizedString(
    ...
    bundle: .module,
    value: "Terms of Use",
    comment: "Show Wooeen Browser TOS page from the Privacy section in the settings."
  )
  public static let privateTabBody = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "Private Tabs aren’t saved in Wooeen, but they don’t make you anonymous online. Sites you visit in a private tab won’t show up in your history and their cookies always vanish when you close them — there won’t be any trace of them left in Wooeen. However, downloads will be saved.\nYour mobile carrier (or the owner of the Wi-Fi network or VPN you’re connected to) can see which sites you visit and those sites will learn your public IP address, even in Private Tabs.",
  ...
  public static let bravePanel = NSLocalizedString(
    ...
    bundle: .module,
    value: "Wooeen Panel",
    comment: "Button to show the Wooeen panel"
  )
  ...
  public static let siteShieldSettings = NSLocalizedString(
    ...
    bundle: .module,
    value: "Shields",
    comment: "Wooeen panel topmost title"
  )
  ...
  public static let leoMenuItem = NSLocalizedString(
    ...
    value: "Leo",
    comment:
      "Title for Wooeen Leo menu item. Wooeen Leo is the name of a product and should not be translated"
  )
  ...
  public static let openExternalAppURLAllow = NSLocalizedString(
    ...
    bundle: .module,
    value: "Allow",
    comment: "Allow Wooeen to open the external app URL"
  )
  public static let openExternalAppURLDontAllow = NSLocalizedString(
    ...
    bundle: .module,
    value: "Don't Allow",
    comment: "Don't allow Wooeen to open the external app URL"
  )
  public static let requestCameraPermissionPrompt = NSLocalizedString(
    ...
    comment:
      "A title that appears on a permissions dialog on whether or not the user wants to allow a web page to access their device's camera. %@ will be replaced with the websites address (for example: \"talk.wooeen.com\")"
  )
  public static let requestMicrophonePermissionPrompt = NSLocalizedString(
    ...
    comment:
      "A title that appears on a permissions dialog on whether or not the user wants to allow a web page to access their device's microphone. %@ will be replaced with the websites address (for example: \"talk.wooeen.com\")"
  )
  public static let requestCameraAndMicrophonePermissionPrompt = NSLocalizedString(
    ...
    comment:
      "A title that appears on a permissions dialog on whether or not the user wants to allow a web page to access their device's camera & microphone. %@ will be replaced with the websites address (for example: \"talk.wooeen.com\")"
  )
  public static let requestCaptureDevicePermissionPrompt = NSLocalizedString(
    ...
    comment:
      "A title that appears on a permissions dialog on whether or not the user wants to allow a web page to access some media capture device such as a camera or microphone. %@ will be replaced with the websites address (for example: \"talk.wooeen.com\")"
  )
  ...
  public static let defaultThemeName =
    NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "Wooeen default",
      comment: "Name for default Wooeen theme."
    )
  public static let themeQRCodeShareTitle =
    NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "Share Wooeen with your friends!",
...
extension Strings {
  ...
  public static let OBJoinButton = NSLocalizedString(
    ...
    bundle: .module,
    value: "Join",
    comment: "Button to join Wooeen Rewards."
  )
  public static let OBTurnOnButton = NSLocalizedString(
    ...
    bundle: .module,
    value: "Start",
    comment: "Button to show Wooeen Rewards."
  )
  public static let OBShowMeButton = NSLocalizedString(
    ...
    bundle: .module,
    value: "Show Me",
    comment: "Button to show the Wooeen Rewards Ads."
  )
  ...
  public static let OBSearchEngineTitle = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "Welcome to Wooeen Browser",
  ...
  public static let OBAdsOptInTitle = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "Wooeen Ads is here!",
    comment: "Title when opting into Wooeen Ads when region becomes available"
  )
  public static let OBAdsOptInMessage = NSLocalizedString(
    ...
    comment: "Message when opting into Wooeen Ads when region becomes available"
  )
  ...
  public static let OBRewardsDetail = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "Opting into Wooeen Private Ads supports publishers and content creators with every ad viewed.",
    comment: "Detail text for rewards onboarding screen"
  )
  ...
  public static let OBAdsTitle = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "Wooeen will show your first ad in",
  ...
  public static let OBPrivacyConsentDetail = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "You may have downloaded Wooeen in support of your referrer. To detect your referrer, Wooeen performs a one-time check of your clipboard for the matching referral code. This check is limited to the code only and no other personal data will be transmitted.  If you opt out, your referrer won’t receive rewards from Wooeen.",
    comment: ""
  )
  public static let OBPrivacyConsentClipboardPermission = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "Allow Wooeen to check my clipboard for a matching referral code",
    comment: ""
  )
  ...
  public struct NTP {
    ...
    public static let earningsReport =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "You earned %@ by browsing with Wooeen.",
        comment: "Placeholder example: 'You earned 42 BAT by browsing with Wooeen.'"
      )
    ...
    public static let learnMoreAboutRewards =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Learn more about Wooeen Rewards",
        comment: ""
      )
    ...
    public static let braveSupportFavoriteTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Wooeen Support",
        comment: "Bookmark title for Wooeen Support"
      )
    ...
    public static let imageTypeSelectionDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "'Sponsored' are additional branded backgrounds you can earn from with Wooeen Rewards enabled.",
...
extension Strings {
  public struct Popover {
    public static let closeShieldsMenu = NSLocalizedString(
      ...
      comment: "Description for closing the `Wooeen Shields` popover menu that is displayed."
    )
  }
}
...
extension Strings {
  public struct Shields {
    public static let toggleHint = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "Double-tap to toggle Wooeen Shields",
    ...
    public static let statusTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "Wooeen Shields",
      comment: "Context: 'Wooeen Shields Up' or 'Wooeen Shields Down'"
    )
    public static let statusValueUp = NSLocalizedString(
      ...
      bundle: .module,
      value: "Up",
      comment: "Context: The 'Up' in 'Wooeen Shields Up'"
    )
    public static let statusValueDown = NSLocalizedString(
      ...
      bundle: .module,
      value: "Down",
      comment: "Context: The 'Down' in 'Wooeen Shields Down'"
    )
    ...
    public static let aboutBraveShieldsTitle = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "About Wooeen Shields",
      comment: "The title of the screen explaining Wooeen Shields"
    )
    ...
    public static let shieldsDownDisclaimer = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "You're browsing this site without Wooeen's privacy protections. Does it not work right with Shields up?",
      comment: ""
    )
    ...
    public static let siteReportedBody = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Thanks for letting Wooeen's developers know that there's something wrong with this site. We'll do our best to fix it!",
      comment: ""
    )
    ...
    public static let reportBrokenSiteBody1 = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "Let Wooeen's developers know that this site doesn't work properly with Shields:",
      comment:
    ...
    public static let reportBrokenSiteBody2 = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Note: The report sent to Wooeen servers will include the site address, Wooeen version number, Shields settings, VPN status, and language settings.",
      comment:
  ...
  public struct ShieldEducation {
    ...
    public static let trackerAdWarningSubtitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Wooeen Shields just protected your online privacy.",
    ...
    public static let shareDescriptionTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Every day I save data by browsing the web with Wooeen.",
        comment: "Text used for social sharing together with Wooeen Shield values"
      )
  ...
  public struct PlayList {
    ...
    public static let noItemLabelDetailLabel =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "You can add items to your Wooeen Playlist within the browser",
    ...
    public static let toastAddedToPlaylistTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Added to Wooeen Playlist",
        comment:
    ...
    public static let urlBarButtonOptionFooter =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Adds a playlist button (it looks like 4 lines with a + symbol) beside the address bar in the Wooeen browser. This button gives you quick access to open Playlist, or add or remove media.",
    ...
    public static let menuBadgeOptionFooterText =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "When enabled, a badge will be displayed on the main menu icon, indicating media on the page may be added to Wooeen Playlist.",
  ...
  public struct PlaylistFolders {
    ...
    public static let playlistFolderMoveItemDescription =
      NSLocalizedString(
        ...
        comment:
          "%@ Should NOT be localized. It is a placeholder. Example: Wooeen Folder and 1 more item."
      )
    ...
    public static let playlistFolderMoveMultipleItemDescription =
      NSLocalizedString(
        ...
        comment:
          "%@ and %lld Should NOT be localized. They are placeholders. Example: Wooeen Folder and 3 more items. Music and 2 more items."
      )
  ...
  public struct PlaylistFolderSharing {
    ...
    public static let addButtonAccessibilityTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Add to Wooeen Playlist Button",
    ...
    public static let playlistSharedFolderAlreadyExistsBody =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "This folder already exists in your Wooeen Playlist",
  ...
  public struct CertificateViewer {
    ...
    public static let organizationTitle =
      NSLocalizedString(
        ...
        bundle: .module,
        value: "Organization",
        comment: "Title of the section for Name of the Company. Example: Wooeen Cashback LTDA."
      )
    ...
    public static let domainComponentTitle =
      NSLocalizedString(
        ...
        comment:
          "Title of the section for the Domain Component such as: DNS or wooeen.com or a website's domain."
      )
  ...
  public struct Shortcuts {
    ...
    public static let activityTypeOpenBookmarksTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Open Wooeen Browser Bookmarks",
        comment: ""
      )
    ...
    public static let activityTypeOpenHistoryListTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Open Wooeen Browser History",
        comment: ""
      )
    ...
    public static let activityTypeClearHistoryTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Clear Wooeen Browsing History",
        comment: ""
      )
    ...
    public static let activityTypeEnableVPNTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Open Wooeen Browser and Enable VPN",
        comment: ""
      )
    ...
    public static let activityTypeTabDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Start Searching the Web Securely with Wooeen",
        comment: ""
      )
    ...
    public static let activityTypeBraveNewsDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Open Wooeen News and Check Today's Top Stories",
        comment: ""
      )
    ...
    public static let activityTypeOpenSyncedTabsDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Open Wooeen Tabs Open in Other Devices",
        comment: ""
      )
    ...
    public static let shortcutSettingsEnableVPNDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Use Shortcuts to enable Wooeen VPN via Siri - Voice Assistant",
        comment: ""
      )
    ...
    public static let shortcutSettingsOpenBraveNewsDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Use Shortcuts to open a new tab & show Wooeen News Feed via Siri - Voice Assistant",
        comment: "Description of Open Wooeen News Siri Shortcut in Settings Screen"
      )
    ...
    public static let shortcutOpenApplicationSettingsDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "This option will open Wooeen Settings. In order to change various Siri options, please select 'Siri & Search' menu item and customize your choices.",
        comment: "Description for opening Wooeen Settings for altering Siri shortcut."
      )
  }
}
  ...
  public struct VPN {
    ...
    public static let checkboxProtectYourDevices =
      NSLocalizedString(
        ...
        comment: "Text for a checkbox to present the user benefits for using Wooeen VPN"
      )
    ...
    public static let checkboxNoIPLog =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Wooeen never logs your activity",
        comment: "Text for a checkbox to present the user benefits for using Wooeen VPN"
      )
    ...
    public static let installProfileTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Wooeen will now install a VPN profile.",
        comment: ""
      )
    ...
    public static let installProfileBody =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "This profile allows the VPN to automatically connect and secure traffic across your device all the time. This VPN connection will be encrypted and routed through Wooeen's intelligent firewall to block potentially harmful and invasive connections.",
    ...
    public static let settingsLinkReceipt =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Link purchase to your Wooeen account",
    ...
    public static let settingsLinkReceiptFooter =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Link your App Store purchase to your Wooeen account to use Wooeen VPN on other devices.",
    ...
    public static let enableButton =
      NSLocalizedString(
        ...
        bundle: .module,
        value: "Enable",
        comment: "Button text to enable Wooeen VPN"
      )
    ...
    public static let buyButton =
      NSLocalizedString(
        ...
        bundle: .module,
        value: "Buy",
        comment: "Button text to buy Wooeen VPN"
      )
    ...
    public static let tryForFreeButton =
      NSLocalizedString(
        ...
        bundle: .module,
        value: "Try for FREE",
        comment: "Button text to try free Wooeen VPN"
      )
    ...
    public static let vpnConfigPermissionDeniedErrorBody =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "The Wooeen Firewall + VPN requires a VPN profile to be installed on your device to work. ",
        comment: "Title for an alert when the user didn't allow to install VPN profile"
      )
    ...
    public static let vpnResetAlertBody =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "This will reset your Wooeen Firewall + VPN configuration and fix any errors. This process may take a minute.",
    ...
    public static let contactFormDoNotEditText =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Wooeen doesn’t track you or know how you use our app, so we don’t know how you've set up VPN. Please share info about the issue you're experiencing and we'll do our best to resolve it as soon as we can.",
    ...
    public static let contactFormTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Wooeen Firewall + VPN Issue",
    ...
    public static let vpnBackgroundNotificationTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Wooeen Firewall + VPN is ON",
    ...
    public static let vpnBackgroundNotificationBody =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Even in the background, Wooeen will continue to protect you.",
        comment: "Notification title to tell user that the vpn is turned on even in background"
      )
    ...
    public static let sessionExpiredDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Please login to your Wooeen Account to refresh your VPN session.",
    ...
    public static let autoRenewSoonExpirePopOverTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Oh no! Your Wooeen VPN subscription is about to expire.",
    ...
    public static let autoRenewDiscountPopOverTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Auto-renew your Wooeen VPN Subscription now and get 20% off for 3 months!",
    ...
    public static let autoRenewFreeMonthPopOverTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Auto-renew your Wooeen VPN Subscription now and get 1 month free!",
    ...
    public static let updateBillingSoonExpirePopOverTitle =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "There's a billing issue with your account, which means your Wooeen VPN subscription is about to expire.",
    ...
    public static let updateBillingExpiredPopOverTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Update your payment info to stay protected with Wooeen VPN.",
    ...
    public static let autoRenewSoonExpirePopOverDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "That means you'll lose Wooeen's extra protections for every app on your phone.",
    ...
    public static let subscribeVPNDiscountPopOverTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Give Wooeen VPN another try and get 20% off for 3 months!",
    ...
    public static let subscribeVPNProtectionPopOverTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Did you know that Wooeen VPN protects you outside of Wooeen Browser?",
        comment: "Pop up title for subscribing VPN explaning VPN protects user outside the Wooeen"
      )
    ...
    public static let subscribeVPNAllDevicesPopOverTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Now, use Wooeen VPN on all your devices for the same price!",
    ...
    public static let subscribeVPNProtectionPopOverDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Wooeen VPN has always blocked trackers on every app, even outside the Wooeen browser. Now you can see who tried to track you, with the Wooeen Privacy Hub.",
        comment:
          "Pop up description for subscribing VPN explaning VPN protects user outside the Wooeen"
      )
    ...
    public static let subscribeVPNAllDevicesPopOverDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "That’s right. Your Wooeen VPN subscription is now good on up to 5 devices. So you can subscribe on iOS and use it on your Mac, Windows and Android devices for free.",
    ...
    public static let subscribeVPNPopOverSubDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Ready to safeguard every app on your phone? Come back to Wooeen VPN and get 20% off for the next 3 months.",
  ...
  public struct Sync {
    ...
    public static let syncDeleteAccountAlertDescriptionPart1 =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Deleting your account will remove your encrypted data from Wooeen servers and disable Sync on all of your connected devices.",
  ...
  public struct Privacy {
    ...
    public static let browserLockDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Unlock Wooeen with Touch ID, Face ID or system passcode.",
  ...
  public struct OpenTabs {
    ...
    public static let noSyncSessionPlaceHolderViewTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "This space shows Wooeen tabs open in other devices",
    ...
    public static let noSyncSessionPlaceHolderViewAdditionalDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Manage what Wooeen syncs in Settings.",
...
extension Strings {
  public struct BraveNews {
    ...
    public static let introCardTitle = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "Turn on Wooeen News, and never miss a story",
      comment: "Shown above a button that turns on the \"Wooeen News\" product in the app."
    )
    public static let introCardBody = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Follow your favorite sources, in a single feed. Just open a tab in Wooeen, scroll down, and… voila!\nWooeen News is ad-supported with private, anonymized ads.",
      comment:
        "Shown above a button that turns on the \"Wooeen News\" product in the app. by sources & feeds they mean websites & blogs."
    )
    ...
    public static let errorGeneralBody = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "Wooeen News is experiencing some issues. Try again.",
      comment: ""
    )
    public static let disablePublisherContent = NSLocalizedString(
      ...
      comment: "'%@' will turn into the name of a publisher (verbatim), for example: Wooeen Blog"
    )
    ...
    public static let disabledAlertBody = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "Wooeen News will stop showing content from %@",
      comment: "'%@' will turn into the name of a publisher (verbatim), for example: Wooeen Blog"
    )
    ...
    public static let moreBraveOffers = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "More Wooeen Offers",
      comment: "'Wooeen Offers' is a product name"
    )
    ...
    public static let addSourceShareTitle = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "Add Source to Wooeen News",
    ...
    public static let getFeedsFromSiteButtonTitle = NSLocalizedString(
      ...
      comment:
        "Shown with a website the user has typed in after the text. For example: 'Get feeds from https://wooeen.com'."
    )
    ...
    public static let rateBraveCardTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "Liking Wooeen?",
      comment: "Title shown on the Rate Wooeen Card "
    )
    public static let rateBraveCardSubtitle = NSLocalizedString(
      ...
      comment: "Subtitle shown on the Rate Wooeen Card"
    )
  }
}
...
extension Strings {
  public struct RewardsInternals {
    public static let title = NSLocalizedString(
      ...
      comment: "'Rewards' as in 'Wooeen Rewards'"
    )
...
extension Strings {
  public struct Rewards {
    public static let enabledBody = NSLocalizedString(
      ...
      comment: "Displayed when Wooeen Rewards is enabled"
    )
    public static let disabledBody = NSLocalizedString(
      ...
      comment: "Displayed when Wooeen Rewards is disabled"
    )
    ...
    public static let disabledStatusBody = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "Using Wooeen Rewards helps support content creators as you browse.",
    ...
    public static let settingsToggleMessage = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "Support content creators and publishers automatically by enabling Wooeen Private Ads. Wooeen Private Ads are privacy-respecting ads that give back to content creators.",
      comment: ""
    )
    ...
    public static let braveTalkRewardsOptInTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "To start a free call, turn on Wooeen Rewards",
        comment: "Title for Wooeen Talk rewards opt-in screen"
      )
    ...
    public static let braveTalkRewardsOptInBody =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "With Wooeen Rewards, you can view privacy-preserving ads from the Wooeen Ads network. No trackers. No slowdowns. And your data stays totally safe.",
        comment: "Body for Wooeen Talk rewards opt-in screen"
      )
    ...
    public static let braveTalkRewardsOptInButtonTitle =
      NSLocalizedString(
        ...
        comment: "Title for Wooeen Talk rewards opt-in screen button"
      )
    ...
    public static let braveTalkRewardsOptInSuccessTitle =
      NSLocalizedString(
        ...
        comment: "Title for successful Wooeen Talk rewards opt-in"
      )
    ...
    public static let braveTalkRewardsOptInSuccessBody =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Click anywhere on the screen to continue to Wooeen Talk.",
        comment: "Body for successful Wooeen Talk rewards opt-in"
      )
  }
}
...
extension Strings {
  public struct Ads {
    public static let myFirstAdTitle = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "This is your first Wooeen ad",
      comment: ""
    )
...
extension Strings {
  public struct PrivacyHub {
    public static let privacyReportsTitle = NSLocalizedString(
      ...
      value: "Privacy Hub",
      comment:
        "Title of main privacy hub screen. This screen shows various stats caught by Wooeen's ad blockers."
    )
    ...
    public static let mostFrequentTrackerAndAdBody = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "**%@** was blocked by Wooeen Shields on **%lld** sites",
      comment:
        "Do NOT localize asterisk('*') characters, they are used to make the text bold in the app. It says which tracker was blocked on how many websites, example usage: 'Google Analytics was blocked by Wooeen Shields on 42 sites'"
    )
    ...
    public static let vpnAlertsHeader = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "Wooeen Firewall + VPN Alerts",
      comment:
    ...
    public static let allVPNAlertsButtonText = NSLocalizedString(
      ...
      value: "All alerts",
      comment:
        "Text for a button to display a list of all alerts caught by the Wooeen VPN. VPN alert is a notificaion of what item has been blocked by the vpn, similar to a regular adblocker"
    )
    ...
    public static let allTimeListsTrackersView = NSLocalizedString(
      ...
      bundle: .module,
      value: "Trackers & ads",
      comment: "Title of a section to show total count of trackers blocked by Wooeen"
    )
    ...
    public static let blockedBy = NSLocalizedString(
      ...
      value: "Blocked by",
      comment:
        "Text which explain by what type of ad blocker a given resource was blocked. Context is like: 'Blocked by Wooeen Shields', 'Blocked by WooeenVPN"
    )
    ...
    public static let vpnLabel = NSLocalizedString(
      ...
      value: "Firewall + VPN",
      comment:
        "This label says about Wooeen VPN, as a source of by what the resource was blocked by. Think of it in context of 'Blocked by VPN'"
    )
    ...
    public static let notificationMessage = NSLocalizedString(
      ...
      tableName: "BraveShared",
      bundle: .module,
      value: "A recap of how Wooeen protected you online this week.",
      comment:
    ...
    public static let settingsEnableShieldsTitle = NSLocalizedString(
      ...
      comment: "Title of a setting that lets Wooeen monitor blocked network requests"
    )
    ...
    public static let settingsEnableShieldsFooter = NSLocalizedString(
      ...
      comment: "This text explains a setting that lets Wooeen monitor blocked network requests"
    )
    ...
    public static let settingsEnableVPNAlertsTitle = NSLocalizedString(
      ...
      comment:
        "Title of a setting that lets Wooeen monitor blocked network requests captured by Wooeen VPN"
    )
    ...
    public static let settingsEnableVPNAlertsFooter = NSLocalizedString(
      ...
      comment:
        "This text explains a setting that lets Wooeen monitor blocked network requests captured by Wooeen VPN"
    )
    ...
    public static let settingsSlearDataTitle = NSLocalizedString(
      ...
      comment:
        "Button that lets user clear all blocked requests and vpn alerts data that Wooeen captured for them."
    )
...
extension Strings {
  public struct P3A {
    public static let settingTitle = NSLocalizedString(
      ...
      comment:
        "The title for the setting that will allow a user to toggle sending privacy preserving analytics to Wooeen."
    )
    ...
    public static let settingSubtitle = NSLocalizedString(
      ...
      bundle: .module,
      value:
        "These private responses help Wooeen estimate the overall usage of certain features and make them better for you.",
      comment: "A subtitle shown on the setting that toggles analytics on Wooeen."
    )
  ...
  public struct VoiceSearch {
    public static let screenDisclaimer =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .module,
        value: "Wooeen does not store or share your voice searches.",
    ...
    public static let microphoneAccessRequiredWarningDescription =
      NSLocalizedString(
        ...
        bundle: .module,
        value:
          "Please allow Microphone Access in iOS System Settings for Wooeen to use anonymous voice search.",
...
extension Strings {
  public struct Hotkey {
    ...
    public static let showShieldsTitle = NSLocalizedString(
      "showShieldsTitle",
      bundle: .module,
      value: "Open Wooeen Shields",
      comment:
        "Label to display in the Discoverability overlay for keyboard shortcuts which is for Showing Wooeen Shields"
    )
...
extension Strings {
  public struct Paywall {
    public static let alreadyPurchasedTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "Already purchased on wooeen.com?",
      comment: "Title label text for refreshing credentials from Wooeen site."
    )
    public static let refreshCredentialsButtonTitle = NSLocalizedString(
      ...
      comment: "Button action text for refreshing credentials from Wooeen site."
    )
  }
}

extension Strings{
    public struct Wooeen {
        public static let woeSearchHint = NSLocalizedString(
          "wooeen.woeSearchHint",
          bundle: .module,
          value: "Find a product with cashback",
          comment: ""
        )
        
        public static let woeSearch = NSLocalizedString(
          "wooeen.woeSearch",
          bundle: .module,
          value: "Search",
          comment: ""
        ...
        public static let woeSearchWords = NSLocalizedString(
          "wooeen.woeSearchWords",
          bundle: .module,
          value: "Fridge, Smart tv, Smartphone, Sofa, Video game console, Hotel, Airline ticket",
          comment: ""
        )
        
        public static let woeHeaderBalance = NSLocalizedString(
          "wooeen.woeHeaderBalance",
          bundle: .module,
          value: "Cashback balance",
          comment: ""
        )
        
        public static let woeCashackActive = NSLocalizedString(
          "wooeen.woeCashackActive",
          bundle: .module,
          value: "Activate cashback",
          comment: ""
        )
        
        public static let woeEnableCamera = NSLocalizedString(
          "wooeen.woeEnableCamera",
          bundle: .module,
          value: "Continue",
          comment: ""
        )
        
        public static let woeEnableCameraDescription = NSLocalizedString(
          "wooeen.woeEnableCameraDescription",
          bundle: .module,
          value: "Wooeen needs to access your camera in order to read the QR code.",
          comment: ""
        )
        
        public static let woeHomeActionCoupons = NSLocalizedString(
          "wooeen.woeHomeActionCoupons",
          bundle: .module,
          value: "Cupons",
          comment: ""
        )
        
        public static let woeHomeActionDiscounts = NSLocalizedString(
          "wooeen.woeHomeActionDiscounts",
          bundle: .module,
          value: "Descontos",
          comment: ""
        )
        
        public static let woeHomeActionEarn = NSLocalizedString(
          "wooeen.woeHomeActionEarn",
          bundle: .module,
          value: "Ganhar",
          comment: ""
        )
        
        public static let woeHomeActionAdvertisers = NSLocalizedString(
          "wooeen.woeHomeActionAdvertisers",
          bundle: .module,
          value: "Lojas",
          comment: ""
        )
        
        public static let woeHomeActionMyData = NSLocalizedString(
          "wooeen.woeHomeActionMyData",
          bundle: .module,
          value: "Cashback",
          comment: ""
        )
        
        public static let woeHomeActionSupport = NSLocalizedString(
          "wooeen.woeHomeActionSupport",
          bundle: .module,
          value: "Ajuda",
          comment: ""
        )
