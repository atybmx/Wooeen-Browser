...
extension Strings {
  struct PlaylistOnboarding {
    public static let introducingBravePlaylist = NSLocalizedString(
      ...
      bundle: .module,
      value: "Introducing Wooeen Playlist",
      comment:
        "A title shown on the first 2 steps of onboarding for Wooeen Playlist. Wooeen Playlist is a product name"
    )
    ...
    public static let playlistOnboardingDescription = NSLocalizedString(
      ...
      comment:
        "A body of text explaining the feature that will be displayed under a title reading 'Introducing Wooeen Playlist'"
    )
    public static let advanceInitialOnboardingButtonTitle = NSLocalizedString(
      ...
      value: "Discover How",
      comment:
        "A button title shown below language introducing the Wooeen Playlist feature. i.e. 'Discover how to use use this feature'"
    )
    public static let dismissOnboardingButtonTitle = NSLocalizedString(
      ...
      value: "Dismiss",
      comment:
        "A button title that allows the user to dismiss the popup explaining the Wooeen Playlist feature"
    )
    ...
    public static let playlistInfoFeaturePointTitleOne = NSLocalizedString(
      ...
      bundle: .module,
      value: "Add videos to Wooeen Playlist. Playback anytime. Even offline",
    ...
    public static let confirmationActionButtonTitle = NSLocalizedString(
      ...
      comment: "A button title that when tapped opens Wooeen Playlist"
    )
