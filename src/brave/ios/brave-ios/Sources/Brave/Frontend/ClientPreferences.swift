...
extension Preferences {
  final public class General {
    ...
    static let blockPopups = Option<Bool>(key: "general.block-popups", default: false)//WOE
  ...
  final public class Search {
    ...
    static let showSuggestions = Option<Bool>(key: "search.show-suggestions", default: true)//WOE default false
    ...
    static let shouldShowSuggestionsOptIn = Option<Bool>(
      ...
      default: false//WOE default true
    )
  ...
  final public class PrivacyReports {
    ...
    static let shouldShowNotificationPermissionCallout =
      Option<Bool>(key: "privacy-hub.show-notification-permission-callout", default: false)//WOE default true
    ...
    static let captureVPNAlerts = Option<Bool>(key: "privacy-hub.capture-vpn-alerts", default: false)//WOE default true
