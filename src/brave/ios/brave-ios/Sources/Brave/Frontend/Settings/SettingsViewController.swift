...
class SettingsViewController: TableViewController {
  ...
  private func makeSections() -> [Static.Section] {
    var list = [
      //WOE defaultBrowserSection,
      //WOE makeFeaturesSection(),
      generalSection,
      displaySection,
      tabsSection,
      securitySection,
...
//        }
  ...
  private lazy var aboutSection: Static.Section = {
    ...
    let coreVersion =
      "Wooeen \(BraveCoreVersionInfo.braveCoreVersion) (\(BraveCoreVersionInfo.chromiumVersion))"
    return Static.Section(
      ...
      rows: [
        ...
        Row(
          ...
          selection: { [unowned self] in
            // Show privacy policy
            let privacy = SettingsContentViewController().then { $0.url = .Wooeen.privacy }
        ...
        Row(
          ...
          selection: { [unowned self] in
            // Show terms of use
            let toc = SettingsContentViewController().then { $0.url = .Wooeen.termsOfUse }
