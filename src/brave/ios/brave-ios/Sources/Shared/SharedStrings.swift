...
extension Strings {
  ...
  public static let unableToOpenURLError = NSLocalizedString(
    ...
    bundle: .module,
    value: "Wooeen cannot open the page because it has an invalid address.",
    comment:
      "The message displayed to a user when they try to open a URL that cannot be handled by Wooeen, or any external app."
  )
...
extension Strings {
  ...
  public static let scanQRCodePermissionErrorMessage = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "Please allow Wooeen to access your device’s camera in ‘Settings’ -> ‘Privacy’ -> ‘Camera’.",
