...
public class ShieldPreferences {
  private static let defaultBlockAdsAndTrackingLevel: ShieldLevel = .disabled //WOE default standard
  private static let defaultHTTPsUpgradeLevel: HTTPSUpgradeLevel = .disabled //WOE default standard
