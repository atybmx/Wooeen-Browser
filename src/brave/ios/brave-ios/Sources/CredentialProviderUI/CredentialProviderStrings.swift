...
extension Strings {
  enum CredentialProvider {
    public static let onboardingViewTitle = NSLocalizedString(
      ...
      comment:
        "The title on a screen shown when the user turns on Wooeen as a password autofill provider"
    )
    public static let onboardingViewSubtitle = NSLocalizedString(
      ...
      comment:
        "The subtitle on a screen shown when the user turns on Wooeen as a password autofill provider"
    )
    public static let onboardingViewFootnote = NSLocalizedString(
      ...
      comment:
        "A footnote shown on a screen shown when the user turns on Wooeen as a password autofill provider. 'iCloud Keychain' is an Apple product."
    )
    ...
    public static let credentialListTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "Wooeen Passwords",
      comment:
        "The title shown at the top of a list of credentials. 'Wooeen' in this case is the company name"
    )
