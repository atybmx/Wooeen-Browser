...
export default html`
  <style>
    ...
    :host(:not([style])) {
      ...
      --brave-brand-color: #3e40e6; /* orange400 */
      --brave-primary-hover: #22236c; /* orange300 */
      --brave-default-hover: rgba(24, 25, 90, 0.1); /* orange400 */
      --brave-focus-outline: rgba(24, 25, 90, 0.4); /* orange400 */
