...
function realbox(cr,lg){
  var input = document.getElementById("realbox-input");
  if(input){
    ...
    autocomplete({
        ...
        fetch: function(text, update) {
          if(autocompleteLoading && autocompleteLoading.state() === 'pending')
            ...
            autocompleteLoading = getJSON(
                'https://search.wooeen.com/c/select/autocomplete?cr='+cr+'&lg='+lg+'&q='+text,
        ...
        render:  function(item, currentValue) {
            ...
            if(item.type === 'category'){
              if(item.icon)
                ...
                itemElement.innerHTML = '<i class="icofont-basket"></i>'+newHtml;

            }else if(item.type === 'advertiser'){
              itemElement.innerHTML = '<i class="icofont-crown"></i>'+newHtml;

            }else{
              itemElement.innerHTML = '<i class="icofont-search"></i>'+newHtml;
            }
