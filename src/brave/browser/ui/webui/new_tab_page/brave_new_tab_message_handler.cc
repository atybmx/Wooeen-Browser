...
base::DictionaryValue GetPreferencesDictionary(PrefService* prefs) {
  ...
  //WOE prefs new tab
  pref_data.SetBoolean("showCtas",
                     prefs->GetBoolean(kNewTabPageShowCtas));
  pref_data.SetBoolean("showRealbox",
                    prefs->GetBoolean(kNewTabPageShowRealbox));
  pref_data.SetBoolean("showNews",
                    prefs->GetBoolean(kNewTabPageShowNews));
  pref_data.SetBoolean("showBalance",
                      prefs->GetBoolean(kNewTabPageShowBalance));
  pref_data.SetBoolean("showCashback",
                      prefs->GetBoolean(kNewTabPageShowCashback));
  pref_data.SetBoolean("showRecommendation",
                      prefs->GetBoolean(kNewTabPageShowRecommendation));
...
void BraveNewTabMessageHandler::OnJavascriptAllowed() {
  ...
  //WOE prefs new tab page
  pref_change_registrar_.Add(
      kNewTabPageShowCtas,
      base::BindRepeating(&BraveNewTabMessageHandler::OnPreferencesChanged,
                          base::Unretained(this)));
  pref_change_registrar_.Add(
      kNewTabPageShowRealbox,
      base::BindRepeating(&BraveNewTabMessageHandler::OnPreferencesChanged,
                          base::Unretained(this)));
  pref_change_registrar_.Add(
      kNewTabPageShowNews,
      base::BindRepeating(&BraveNewTabMessageHandler::OnPreferencesChanged,
                          base::Unretained(this)));
  pref_change_registrar_.Add(
      kNewTabPageShowBalance,
      base::BindRepeating(&BraveNewTabMessageHandler::OnPreferencesChanged,
                          base::Unretained(this)));
  pref_change_registrar_.Add(
      kNewTabPageShowCashback,
      base::BindRepeating(&BraveNewTabMessageHandler::OnPreferencesChanged,
                          base::Unretained(this)));
  pref_change_registrar_.Add(
      kNewTabPageShowRecommendation,
      base::BindRepeating(&BraveNewTabMessageHandler::OnPreferencesChanged,
                          base::Unretained(this)));
}
...
void BraveNewTabMessageHandler::HandleSaveNewTabPagePref(
  ...
  } else if (settingsKeyInput == "showCtas") {//WOE prefs new tab
    settingsKey = kNewTabPageShowCtas;
  } else if (settingsKeyInput == "showRealbox") {
    settingsKey = kNewTabPageShowRealbox;
  } else if (settingsKeyInput == "showNews") {
    settingsKey = kNewTabPageShowNews;
  } else if (settingsKeyInput == "showBalance") {
    settingsKey = kNewTabPageShowBalance;
  } else if (settingsKeyInput == "showCashback") {
    settingsKey = kNewTabPageShowCashback;
  } else if (settingsKeyInput == "showRecommendation") {
    settingsKey = kNewTabPageShowRecommendation;
