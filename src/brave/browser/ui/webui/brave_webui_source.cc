  ...
  static std::map<std::string, std::vector<WebUISimpleItem> >
                                                           localized_strings = {
    {
      std::string("newtab"), {
        ...
        { "woeCtasTitle", IDS_WOE_CTAS_TITLE },
        { "woeShowCtas", IDS_WOE_CTAS_SHOW },
        { "woeNewsTitle", IDS_WOE_NEWS_TITLE },
        { "woeShowNews", IDS_WOE_NEWS_SHOW },
        { "woeCtasWidgetTitle", IDS_WOE_CTAS_WIDGET_TITLE },
        { "woeRealboxTitle", IDS_WOE_REALBOX_TITLE },
        { "woeShowRealbox", IDS_WOE_REALBOX_SHOW },
        { "woeRealboxWidgetTitle", IDS_WOE_REALBOX_WIDGET_TITLE },
        ...
        { "woeNewsPosts", IDS_WOE_NEWS_POSTS},
        { "woeNewsTasks", IDS_WOE_NEWS_TASKS},
        { "woeNewsOffers", IDS_WOE_NEWS_OFFERS},
        { "woeNewsCoupons", IDS_WOE_NEWS_COUPONS},
        { "woeCashbackCtaAreaEnable", IDS_WOE_CASHBACK_CTA_AREA_ENABLE},
        { "woeCashbackCtaArea", IDS_WOE_CASHBACK_CTA_AREA},
        { "woeCashbackCtaAdvertisers", IDS_WOE_CASHBACK_CTA_ADVERTISERS},
        { "woeCashbackCtaShare", IDS_WOE_CASHBACK_CTA_SHARE},
        { "woeCashbackCtaShareCopy", IDS_WOE_CASHBACK_CTA_SHARE_COPY},
        { "woeCashbackCtaShareCopied", IDS_WOE_CASHBACK_CTA_SHARE_COPIED},
        { "woeContentShareCopied", IDS_WOE_CONTENT_SHARE_COPIED},
        { "woeActiveCoupon", IDS_WOE_ACTIVE_COUPON},
        { "woeExpireIn", IDS_WOE_EXPIRE_IN},
        { "woeDaysSymbol", IDS_WOE_DAYS_SYMBOL},
        { "woeHoursSymbol", IDS_WOE_HOURS_SYMBOL},
        { "woeMinutesSymbol", IDS_WOE_MINUTES_SYMBOL},
        { "woeSecondsSymbol", IDS_WOE_SECONDS_SYMBOL},
        ...
        //Balance widget
        { "woeWidgetBalanceTitle", IDS_WOE_WIDGET_BALANCE_TITLE },
        { "woeWidgetBalanceDesc", IDS_WOE_WIDGET_BALANCE_DESC },
        { "woeWidgetBalanceSubtitle", IDS_WOE_WIDGET_BALANCE_SUBTITLE },
        { "woeWidgetBalanceBtn", IDS_WOE_WIDGET_BALANCE_BTN },
        { "woeWidgetBalanceBtnDisabled", IDS_WOE_WIDGET_BALANCE_BTN_DISABLED },
        { "woeWidgetBalancePref", IDS_WOE_WIDGET_BALANCE_PREF },
        { "woeWidgetBalancePs", IDS_WOE_WIDGET_BALANCE_PS },

        //Cashback widget
        { "woeWidgetCashbackTitle", IDS_WOE_WIDGET_CASHBACK_TITLE },
        { "woeWidgetCashbackDesc1", IDS_WOE_WIDGET_CASHBACK_DESC1 },
        { "woeWidgetCashbackDesc2", IDS_WOE_WIDGET_CASHBACK_DESC2 },
        { "woeWidgetCashbackBtn", IDS_WOE_WIDGET_CASHBACK_BTN },
        { "woeWidgetCashbackPref", IDS_WOE_WIDGET_CASHBACK_PREF },

        //Recommendation widget
        { "woeWidgetRecommendationsTitle", IDS_WOE_WIDGET_RECOMMENDATION_TITLE },
        { "woeWidgetRecommendationsDesc1", IDS_WOE_WIDGET_RECOMMENDATION_DESC1 },
        { "woeWidgetRecommendationsDesc2", IDS_WOE_WIDGET_RECOMMENDATION_DESC2 },
        { "woeWidgetRecommendationsDesc3", IDS_WOE_WIDGET_RECOMMENDATION_DESC3 },
        { "woeWidgetRecommendationsBtn", IDS_WOE_WIDGET_RECOMMENDATION_BTN },
        { "woeWidgetRecommendationPref", IDS_WOE_WIDGET_RECOMMENDATION_PREF },

        //Realbox
        { "woeRealboxInputPlaceholder", IDS_WOE_REALBOX_INPUT_PLACEHOLDER },
      ...
      std::string("welcome"), {
        ...
        { "woeWelcome", IDS_WOE_WELCOME_PAGE_MAIN_TITLE },
        { "woeWelcomeDesc", IDS_WOE_WELCOME_PAGE_MAIN_DESC },
        { "woeCashbackTitle", IDS_WOE_WELCOME_PAGE_CASHBACK_TITLE },
        { "setupWoeCashback", IDS_WOE_WELCOME_PAGE_CASHBACK_DESC },
        { "woeCashbackTerms", IDS_WOE_WELCOME_PAGE_CASHBACK_TERMS },
        { "woeCashbackNote", IDS_WOE_WELCOME_PAGE_CASHBACK_NOTE },
        { "enableCashback", IDS_WOE_WELCOME_PAGE_CASHBACK_BUTTON },
      }
    }, {
      std::string("rewards"), {
