...
void RegisterProfilePrefs(user_prefs::PrefRegistrySyncable* registry) {
  ...
  registry->RegisterBooleanPref(brave_rewards::prefs::kHideButton, true);
  ...
  // Enable home button
  registry->SetDefaultPrefValue(prefs::kShowHomeButton,
                                base::Value(true));
  ...
  //WOE New tab page
  registry->RegisterBooleanPref(kNewTabPageShowCtas, true);
  registry->RegisterBooleanPref(kNewTabPageShowRealbox, true);
  registry->RegisterBooleanPref(kNewTabPageShowNews, true);
  registry->RegisterBooleanPref(kNewTabPageShowBalance, true);
  registry->RegisterBooleanPref(kNewTabPageShowCashback, true);
  registry->RegisterBooleanPref(kNewTabPageShowRecommendation, true);
