...
const PrefsUtil::TypedPrefMap& BravePrefsUtil::GetAllowlistedKeys() {
  ...
  (*s_brave_allowlist)[kNewTabPageShowsOptions] =
      settings_api::PrefType::PREF_TYPE_NUMBER;
  //WOE new tab page prefs
  (*s_brave_allowlist)[kNewTabPageShowCtas] =
      settings_api::PrefType::PREF_TYPE_BOOLEAN;
  (*s_brave_allowlist)[kNewTabPageShowRealbox] =
      settings_api::PrefType::PREF_TYPE_BOOLEAN;
  (*s_brave_allowlist)[kNewTabPageShowNews] =
      settings_api::PrefType::PREF_TYPE_BOOLEAN;
  (*s_brave_allowlist)[kNewTabPageShowBalance] =
      settings_api::PrefType::PREF_TYPE_BOOLEAN;
  (*s_brave_allowlist)[kNewTabPageShowCashback] =
      settings_api::PrefType::PREF_TYPE_BOOLEAN;
  (*s_brave_allowlist)[kNewTabPageShowRecommendation] =
      settings_api::PrefType::PREF_TYPE_BOOLEAN;
#if BUILDFLAG(CRYPTO_DOT_COM_ENABLED)
