...
RegisterPolymerTemplateModifications({
  'settings-basic-page': (templateContent) => {
    ...
    if (!basicPageEl) {
      ...
      sectionAppearance.insertAdjacentElement('afterend', sectionPrivacy)
      // Insert sync
      ...
      sectionSearch.setAttribute('hidden', '[[!pageVisibility.a11y]')
      // sectionPrivacy.insertAdjacentElement('afterend', sectionSearch)
      // Insert extensions
      sectionPrivacy.insertAdjacentElement('afterend', sectionExtensions)
      // Insert Wallet
