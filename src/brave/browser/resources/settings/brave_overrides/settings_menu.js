...
RegisterPolymerTemplateModifications({
  'settings-menu': (templateContent) => {
    ...
    //   'socialBlocking',
    // )
    // appearanceBrowserEl.insertAdjacentElement('afterend', embedEl)

    // Move search item
    const searchEl = getMenuElement(templateContent, '/search')
    searchEl.setAttribute('hidden', '[[!pageVisibility.a11y]')
    // appearanceBrowserEl.insertAdjacentElement('afterend', searchEl)
    ...
    appearanceBrowserEl.insertAdjacentElement('afterend', extensionEl)
    ...
    downloadsEl.insertAdjacentElement('afterend', privacyEl)

    const safetyEl = getMenuElement(templateContent, '/safetyCheck')
    privacyEl.insertAdjacentElement('afterend', safetyEl)
