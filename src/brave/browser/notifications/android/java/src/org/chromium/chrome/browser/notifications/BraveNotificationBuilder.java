...
public class BraveNotificationBuilder extends StandardNotificationBuilder {
    ...
    public NotificationBuilderBase setChannelId(String channelId) {
        return super.setChannelId(
                mIsBraveAdsNotification ? BraveChannelDefinitions.ChannelId.WOOEEN_ADS : channelId);
    }
    ...
    public NotificationWrapper build(NotificationMetadata metadata) {
        ...
        setChannelId(BraveChannelDefinitions.ChannelId.WOOEEN_ADS);
        ...
        String channelId = (ApplicationStatus.hasVisibleActivities())
                ? BraveChannelDefinitions.ChannelId.WOOEEN_ADS
                : BraveChannelDefinitions.ChannelId.WOOEEN_ADS_BACKGROUND;
