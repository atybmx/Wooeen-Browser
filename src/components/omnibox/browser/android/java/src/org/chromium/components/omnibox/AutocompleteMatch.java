...
public class AutocompleteMatch {
    ...
    private boolean mCashbackType;

    public void setCashbackType(boolean mCashbackType){
      this.mCashbackType = mCashbackType;
    }

    public boolean isCashbackType(){
      return mCashbackType;
    }
